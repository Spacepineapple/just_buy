          ...
          <div class="shop-card clothing">
            <Link to="/category/womens-dresses">
              ...
              <img
                ...
                alt=""
              />
              <p class="shop-card__caption">Women's Dresses</p>
            </Link>
          </div>
          ...
          <div class="shop-card footwear">
            <Link to="/category/mens-shoes">
              ...
              <img
                ...
                alt=""
              />
              <p class="shop-card__caption">Men's Shoes</p>
            </Link>
          </div>
          <div class="shop-card tech">
            <Link to="/category/laptops">
              ...
              <img
                ...
                alt=""
              />
              <p class="shop-card__caption">Laptops</p>
            </Link>
          </div>
          <div class="shop-card home">
            <Link to="/category/furniture">
              ...
              <img
                ...
                alt=""
              />
              <p class="shop-card__caption">Furniture</p>
            </Link>
          </div>
          <div class="shop-card beauty">
            <Link to="/category/skincare">
              ...
              <img
                ...
                alt=""
              />
              <p class="shop-card__caption">Skincare</p>
            </Link>
          </div>
        </div>
      </section>
