...
function Terms() {
  return (
    <div className="container custom-container">
      ...
      <p>
        Just Buy is a registered trademark. All text including but not limited
        to prices and delivery timeframes are indicative and do not represent a
      ...
      <div className="terms-area">
        ...
        <p>
          ...
          accept these terms and conditions. Do not continue to use JustBuy if
        ...
        <p>
          Unless otherwise stated, JustBuy and/or its licensors own the
          intellectual property rights for all material on JustBuy. All
          intellectual property rights are reserved. You may access this from
          JustBuy for your own personal use subjected to restrictions set in
        ...
        <p>
          ...
          JustBuy does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of JustBuy,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, JustBuy shall not be liable
          ...
          appearance of the Comments on this website. You warrant and represent
          that:
        </p>
        <ul>
          <li>
        ...
        <p>
          You hereby grant JustBuy a non-exclusive license to use, reproduce,
